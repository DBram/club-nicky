...
class CoachesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post coaches_url, params: { coach: { address: @coach.address, coach_type: @coach.coach_type, email: @coach.email, name: @coach.name, user_id: @coach.user_id } }
    end
  ...
  test "should update coach" do
    patch coach_url(@coach), params: { coach: { address: @coach.address, coach_type: @coach.coach_type, email: @coach.email, name: @coach.name, user_id: @coach.user_id } }
